import { DownloadIcon, EyeIcon, RefreshIcon } from '@heroicons/react/outline'
...
export default function Editor(props: EditorProps) {
  ...
  async function reset() {
    // Clear the lines array except the first empty line

    // Reset brush size and other states if needed
    setBrushSize(40)
    setShowBrush(false)
    ...
    if (context && original.src) {
      await loadImage(render, original.src)
      context.drawImage(render, 0, 0)
    }
